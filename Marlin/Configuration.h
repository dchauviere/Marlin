...
#define STRING_CONFIG_H_AUTHOR "David Chauviere" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,420}  // default steps per unit for Ultimaker
